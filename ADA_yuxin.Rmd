...
We need to create a term for the x\*log(x) and then run a logistic regression with that term. Remember, a SIGNIFICANT (i.e. p \< .05) coefficient means the assumption IS VIOLATED.
